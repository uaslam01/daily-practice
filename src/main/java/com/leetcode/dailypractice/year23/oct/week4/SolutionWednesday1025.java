...
/**
 * https://leetcode.com/problems/k-th-symbol-in-grammar/ We build a table of n
 * rows (1-indexed). We start by writing 0 in the 1st row. Now in every
...
public class SolutionWednesday1025 {
	// Going to use bit negatiion operation, because on close deep look, getting
	// prevBinary+revert(prevBinary)
