...
/**
 * https://leetcode.com/problems/longest-palindromic-substring/ Count Vowels
 * Permutation Hard 3K 205 Companies Given an integer n, your task is to count
 * how many strings of length n can be formed under the following rules:
 * 
