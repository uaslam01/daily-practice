 ...
 * 191. Number of 1 Bits Easy 6.2K 1.3K Companies Write a function that takes
 * the binary representation of an unsigned integer and returns the number of
 ...
 */
public class SolutionWednesday1129 {
    // you need to treat n as an unsigned value
    public int hammingWeigh1t(int n) {
        return Integer.toBinaryString(n).split("1").length;
    }
    //Best Solution
    ...
    public static void main(String[] args) {
		...
		var obj = new SolutionWednesday1129();
		cons.accept(obj.hammingWeight(1));
		cons.accept(obj.hammingWeight(2));
		cons.accept(obj.hammingWeight(3131));
