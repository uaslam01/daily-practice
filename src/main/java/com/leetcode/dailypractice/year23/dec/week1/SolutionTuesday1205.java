 ...
 * <pre>
 * <a href=
 * "https://leetcode.com/problems/count-of-matches-in-tournament/">Problem-Link</a>
 * 
 * 1688. Count of Matches in Tournament
 * 
 * Easy 1.7K 234 Companies You are given an integer n, the number of teams in a
 ...
 * Constraints:
 * 
 * 1 <= n <= 200 Accepted 217.8K Submissions 253.7K Acceptance Rate 85.9% Seen
 * this question in a real interview before? 1/4
 */
public class SolutionTuesday1205 {
	//Mine
    ...
    public static void main(String[] args) {
		...
		var obj = new SolutionTuesday1205();
		cons.accept(obj.numberOfMatches(7));
		cons.accept(obj.numberOfMatches(14));
