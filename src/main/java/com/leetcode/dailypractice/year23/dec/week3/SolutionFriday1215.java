...
/**
 * <pre>
 * <a href="https://leetcode.com/problems/destination-city/">Problem-Link</a>
 * 
 * 1436. Destination City Easy 1.9K 91 Companies
 * 
...
public class SolutionFriday1215 {
	...
	public static void main(String[] args) {
		...
		cons.accept(obj.destCity(Arrays.asList(Arrays.asList("London", "New York"), Arrays.asList("New York", "Lima"),
				Arrays.asList("Lima", "Sao Paulo"))));
		cons.accept(
				obj.destCity(Arrays.asList(Arrays.asList("B", "C"), Arrays.asList("D", "B"), Arrays.asList("C", "A"))));
		cons.accept(obj.destCity(Arrays.asList(Arrays.asList("A", "Z"))));
	}
}
