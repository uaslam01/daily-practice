 ...
 * Constraints:
 * 
 * 1 <= nums.length <= 1000 -231 <= nums[i] <= 231 - 1 Accepted 115.2K
 * Submissions 221.3K Acceptance Rate 52.1%
 **/
public class SolutionSunday0107 {
	...
	public static void main(String[] args) {
		...
		var obj = new SolutionSunday0107();
		cons.accept(obj.numberOfArithmeticSlices(new int[] { 2,4,6,8,10 }));
		cons.accept(obj.numberOfArithmeticSlices(new int[] { 7,7,7,7,7 }));
